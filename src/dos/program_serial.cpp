...
void SERIAL::AddMessages() {
	MSG_Add("SHELL_CMD_SERIAL_HELP_LONG",
	        ...
	        "\n"
	        "Where:\n"
	        "  [color=cyan]TYPE[reset]  One of: [color=cyan]MODEM[reset], [color=cyan]NULLMODEM[reset], [color=cyan]SERIALMOUSE[reset], [color=cyan]DIRECTSERIAL[reset], [color=cyan]DUMMY[reset], [color=cyan]DISABLED[reset]\n"
	        "\n"
	        ...
	        "  For [color=cyan]SERIALMOUSE[reset]  : IRQ, RATE (NORMAL or SMOOTH), TYPE (2BTN, 3BTN, WHEEL,\n"
	        "                     MSM, 2BTN+MSM, 3BTN+MSM, or WHEEL+MSM)\n"
	        ...
	        "  [color=green]SERIAL[reset] [color=white]1[reset] [color=cyan]SERIALMOUSE[reset] TYPE:MSM                : Mouse Systems mouse\n");
